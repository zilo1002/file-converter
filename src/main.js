      ...
      '<div class="rounded-2xl bg-slate-800/20 border border-slate-700/30 p-6 space-y-4">'+
        '<div class="space-y-2">'+
          ...
          '<div class="flex flex-col sm:flex-row gap-2">'+
            '<input type="text" id="githubUrl" placeholder="'+t('githubUrlHint')+'" class="flex-1 min-w-0 w-full bg-slate-800 border border-slate-600 rounded-xl px-4 py-2.5 text-sm text-slate-200 focus:border-purple-500 focus:outline-none placeholder-slate-500">'+
            '<button onclick="window.pasteGitHubUrl()" class="px-4 py-2.5 rounded-xl bg-slate-700 text-slate-300 hover:bg-slate-600 transition-colors text-sm font-medium shrink-0 whitespace-nowrap">'+t('paste')+'</button>'+
          '</div>'+
