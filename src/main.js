  ...
  app.innerHTML = '<div class="min-h-screen bg-slate-950 view-enter">'+
    ...
    '<main class="max-w-3xl mx-auto px-4 sm:px-6 py-6 space-y-6 w-full">'+
      '<div class="rounded-2xl bg-slate-800/20 border border-slate-700/30 p-4 sm:p-6 space-y-3 sm:space-y-4 overflow-hidden">'+
        '<div class="space-y-2">'+
          '<label class="text-xs sm:text-sm font-medium text-slate-300">'+t('githubUrlLabel')+'</label>'+
          '<div class="flex flex-col sm:flex-row gap-2">'+
            '<input type="text" id="githubUrl" placeholder="'+t('githubUrlHint')+'" class="flex-1 min-w-0 w-full bg-slate-800 border border-slate-600 rounded-xl px-3 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm text-slate-200 focus:border-purple-500 focus:outline-none placeholder-slate-500">'+
          ...
          '</div>'+
          '<p class="text-[10px] text-slate-500 leading-relaxed">'+t('githubUrlHint')+'</p>'+
        '</div>'+
        ...
        '</div>'+
        '<div id="githubRateInfo" class="flex items-center justify-between text-[10px] text-slate-500 flex-wrap gap-1">'+
