...
export const I18N = {
  zh: {
    ...
    invalidGitHubUrl: '链接格式不正确，请使用 github.com/owner/repo/blob/branch/path 或 tree 格式',
    downloading: '下载中…',
    ...
    newBadge: 'NEW',
    download: 'Download',
    githubDesc: 'Paste a GitHub file or folder link to download directly',
    githubSubtitle: 'Supports files & folders, zero upload, pure frontend',
    githubUrlLabel: 'GitHub URL',
    paste: 'Paste',
    githubUrlHint: 'e.g. https://github.com/owner/repo/blob/main/README.md',
    githubRateHint: 'GitHub API rate limit: {remain}/{limit} per hour',
    githubNoteTitle: 'Notes',
    githubNote1: 'File downloads use raw.githubusercontent.com (no API quota)',
    githubNote2: 'Folder downloads use GitHub API (unauthenticated: 60/hr)',
    githubNote3: 'Large folders may take a while to zip, please be patient',
    githubNote4: 'Private repos are not supported; public repos only',
    enterUrl: 'Please enter a GitHub URL',
    invalidGitHubUrl: 'Invalid URL. Use github.com/owner/repo/blob/branch/path or tree',
    downloading: 'Downloading…',
    githubFetching: 'Fetching file info…',
    githubProgress: 'Downloaded {done}/{total} · {name}',
    downloadSuccess: 'Download success',
    githubZipSuccess: 'Packed: {done}/{total} files',
    ...
    offlineMode: '离线模式',
    offlineModeDesc: '部分功能可能受限',
    onlineMode: '已恢复在线',
    networkError: '网络连接已断开',
    installApp: '安装应用',
    installAppDesc: '添加到桌面，离线也能用',
    updateAvailable: '发现新版本',
    updateNow: '立即更新',
    later: '稍后',
    uploadDisabledOffline: '离线状态下无法上传新文件',
    // === 阶段四：性能与体验 ===
    chunkReading: '正在分片读取大文件...',
    parse: '解析',
    convert: '转换',
    generate: '生成',
    dragToReorder: '拖拽排序',
    ...
    passwordSet: '已设置密码',
    clearPassword: '清除密码',
    watermarkHint: '水印需本地字体：请将 NotoSansCJKsc-Regular.ttf 放到 public/fonts/ 目录',
    dragToSort: '拖拽排序',
    pageCount: '页',
  ...
  en: {
    ...
    offlineModeDesc: 'Some features may be limited',
    onlineMode: 'Back online',
    networkError: 'Network connection lost',
    installApp: 'Install App',
    installAppDesc: 'Add to home screen for offline use',
    updateAvailable: 'Update available',
    updateNow: 'Update now',
    later: 'Later',
    uploadDisabledOffline: 'Cannot upload files while offline',
    // === Phase 4: Performance & UX ===
    chunkReading: 'Reading large file in chunks...',
    parse: 'Parse',
    convert: 'Convert',
    generate: 'Generate',
    ...
    themeLight: 'Light',
    themeAuto: 'Auto',
    renameConflict: 'Duplicate filename detected, auto-renamed',
    // === Phase 5: Extensions ===
    history: 'History',
    ...
    logHeader: 'FormatHub Conversion Report',
    logGeneratedAt: 'Generated at',
    logTotalFiles: 'Total files',
    logSuccess: 'Success',
    logFailed: 'Failed',
    logDetails: 'Details',
    ...
    watermarkHint: 'Watermark requires local font: place NotoSansCJKsc-Regular.ttf in public/fonts/',
