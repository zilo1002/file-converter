...
export const I18N = {
  zh: {
    ...
    zipExtractNormal: 'ZIP 正常解压',
    zipExtractFlat: 'ZIP 扁平解压',
    extractMergeBtn: '多 ZIP 合并解压',
    needTwoZip: '请至少选择 2 个 ZIP 文件',
    extractMergeDone: '合并解压完成',
    zipExtract: 'ZIP 内容提取',
    selected: '已选',
    downloadSelected: '下载选中',
    noFileSelected: '请先选择文件',
    extractMergeTitle: '多 ZIP 合并解压',
    // === PDF 工具箱 ===
    pdfToolSelect: '选择工具',
    pdfSplit: 'PDF 拆分',
    pdfMerge: 'PDF 合并',
  ...
  en: {
    ...
    zipExtractNormal: 'ZIP Extract (Normal)',
    zipExtractFlat: 'ZIP Extract (Flat)',
    extractMergeBtn: 'Multi-ZIP Merge Extract',
    needTwoZip: 'Please select at least 2 ZIP files',
    extractMergeDone: 'Merge extract completed',
    zipExtract: 'ZIP Contents',
    selected: 'selected',
    downloadSelected: 'Download Selected',
    noFileSelected: 'Please select files first',
    extractMergeTitle: 'Multi-ZIP Merge Extract',
    // === PDF Toolbox ===
...
export const CATEGORIES = {
  ...
  data: {
    ...
    targets: {
      ...
      'zip-extract-normal': { label: 'ZIP 正常解压', labelEn: 'ZIP Extract (Normal)', ext: 'zip' },
      'zip-extract-flat': { label: 'ZIP 扁平解压', labelEn: 'ZIP Extract (Flat)', ext: 'zip' }
    }
  },
  pdf: {
    id: 'pdf',
...
export const SUPPORTED_MATRIX = {
  ...
  data: {
    ...
    zip:   ['zip', 'zip-extract-normal', 'zip-extract-flat'],
    rar:   [],
    '7z':  []
  }
};
