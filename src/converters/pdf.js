...
const CHINESE_FONT_URL = 'https://chinese-font.netlify.app/packages/dyh/dist/%E5%BE%97%E6%84%8F%E9%BB%91/result.ttf';

async function loadChineseFont() {
  if (cachedFontBytes) return cachedFontBytes;
  const res = await fetch(CHINESE_FONT_URL);
  if (!res.ok) throw new Error('中文字体加载失败，请检查网络连接');
